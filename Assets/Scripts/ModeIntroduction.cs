...
public class ModeIntroduction : MonoBehaviour
{
    ...
    public GameObject ModeEquation;
    ...
    void Update()
    {
        ...
        {
            TutorialText.text = "This is the MODE lesson\n" +
                    "Your goal is to do a time study to determine the most frequently \noccuring time value it takes a drill to be assembled\n" +
        ...
        else if (State == 3 && OVRInput.GetDown(OVRInput.Button.One))
        {
            TutorialText.text = "The tools available to you are a calculator, a notebook, a stopwatch, and a graph.\n" +
                    ...
                    "Before beginning, please take a moment to review the description of mode\n." +
                    "\nPress A to continue";
            State++;
    ...
    void ModeDemo()
    {
        if (equation == null)
        {
            equation = Instantiate(ModeEquation); //instantiates the mean equation demo
